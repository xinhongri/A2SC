...
if __name__ == '__main__':
    ...
    Img = data['trainImages_space'].astype(np.float32)/255
    ...
    model_path = '/srv/hd2/xuyikun/backup/2022AAAI/CIFAR10/results/preCIFAR10_4000space/'
    if not os.path.exists(model_path):
        os.makedirs(model_path)
    model_path1 = model_path + 'CIFAR10.ckpt'
    model_name = 'CIFAR10_space'
