...
def err_rate(gt_s, s):
	...
	sio.savemat('/srv/hd2/xuyikun/backup/2022AAAI/CIFAR10/results/DSC_CIFAR10_4000space4.mat', mdict={'C_space': c_x})
	return missrate, NMI(gt_s, c_x)

data = sio.loadmat('/srv/hd2/xuyikun/backup/2022AAAI/CIFAR10/CIFAR10_4000space.mat')
I = data['trainImages_space'].astype(np.float32)/255
...
model_path0 = '/srv/hd2/xuyikun/backup/2022AAAI/CIFAR10/results/preCIFAR10_4000space/'
